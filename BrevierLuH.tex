...
\documentclass[initial=VaticanianInitials,staff=19,font=greciliae,11pt,a4paper,openany,twoside,choralsign=PfefferMediaeval]{gregorian}
...
\setmainfont[Microtype,Ligatures={Common,TeX},Numbers=OldStyle]{Garamond Premier Pro}
...
\vskip3em
{\large\bfseries\sffamily\scshape Martin-Niemöller-Haus Jena}
 \vfill
\end{center}
\newpage
\thispagestyle{empty}
