...
Bewahre meine Seele, denn \emph{'ich} bin Dein: \grestar{} hilf Du, mein \textsc{Gott}, Deinem Knechte, der sich \underline{auf} \emph{'Dich ver}lässt.\par
 ...
 \einzug{In der Not rufe \emph{'ich} Dich an: \grestar{} Du wollest mich \underline{er}\emph{'hö}ren.\par
 \textsc{Herr}, es ist Dir keiner gleich unter den \emph{'Göt}tern: \grestar{} und was Du tust, \underline{kann} \emph{'nie}mand tun.}
 ...
 \einzug{Dass Du so groß bist und \emph{'Wun}der tust: \grestar{} und Du allei\underline{ne} \emph{'\textsc{Gott}} bist.}
 Weise mir, \textsc{Herr}, \emph{'Dei}nen Weg: \grestar{} dass ich wandle in Dei\underline{ner} \emph{'Wahr}heit.\par
 \einzug{Erhalte mein Herz bei dem \emph{'Ei}nen: \grestar{} dass ich Deinen Na\underline{men} \emph{'fürch}te.}
 ...
 \einzug{Denn groß gegen mich ist Deine \emph{'Gü}te: \grestar{} Du hast mich errettet aus der Tiefe \underline{des} \emph{'To}des.}
 ...
 \einzug{Du aber, \textsc{Herr} \textsc{Gott}, bist barmherzig und \emph{'gnä}dig: \grestar{} geduldig und von großer Güte \underline{und} \emph{'Treu}e.}
 ...
 \einzug{Tu ein Zeichen an mir, dass Du es gut mit mir mei\underline{nest} \gredagger{} dass es sehen, die mich \emph{'has}sen: \grestar{} und sich schämen, weil Du mir beistehest, \textsc{Herr}, und \underline{mich} \emph{'trös}test.}
 Ehre sei dem \textsc{Vater} und dem \textsmcpit{'Soh}\textsc{ne:} \grestar{} und dem \textsc{Heili\underline{gen}} \textsmcpit{'Geis}\textsc{te}.\par
 \einzug{Wie im Anfang, so auch jetzt und \emph{'al}lezeit: \grestar{} und in Ewig\underline{keit} \emph{'A}men.}
