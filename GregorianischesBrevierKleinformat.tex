...
\documentclass[initial=ZallmanCaps,staff=18,font=greciliae,11pt,b5paper,openany,twoside,choralsign=PfefferMediaeval]{gregorian}
...
\frontmatter
\thispagestyle{empty}
\ThisTileWallPaper{\paperwidth}{\paperheight}{lskj.pdf}
\phantom{l}
\vskip12em
\begin{center}
...
\vskip3em
{\large\bfseries\sffamily Liturgischer Singkreis Jena}
 \vfill
\end{center}
\newpage
\thispagestyle{empty}
...
\vfill
\begin{framed}
3. Aufl. ©~2008. \textit{Auf der Grundlage des Buches Liturgie III und des Breviarium Lipsiensæ der Evangelisch Lutherischen Gebetsbruderschaft erstellt und bearbeitet von:}\par
...
\input{reisesegen}
\input{rsp-prolixa}
\input{vaterunser-anhang}
\input{glaubensbekenntnis}
\input{complet-advent}
\input{lateinisch}
\end{document}
